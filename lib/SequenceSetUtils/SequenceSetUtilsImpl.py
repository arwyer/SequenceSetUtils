...
class SequenceSetUtils:
    ...
    GIT_COMMIT_HASH = "d3344ed78f1411ea7adb6fbbc757151e1c718326"
    ...
    def buildFromFasta(self, ctx, in):
        """
        ...
        SequenceSet['description'] = 'SequenceSet built from ' + in['path']
        SequenceSet['sequences'] = []
        fastaFile = open(in['path'],'r')
        Sequence = {}
        ...
        save_objects_params = {}
        save_objects_params['id'] = dfu.ws_name_to_id(in['ws_name'])
    ...
    def buildFromLocations(self, ctx, in):
        """
    ...
    def buildFromFeatureSet(self, ctx, in):
        """
        ...
        objectRefs = {'object_refs' : [in['FeatureSet_ref']]}
...
'ref':in['genome_ref']}])
        ...
        objname = 'SequenceSet' + str(int((datetime.utcnow() - datetime.utcfromtimestamp(0)).total_seconds()*1000))
        SequenceSet['sequence_set_id'] = objname
        SequenceSet['description'] = 'SequenceSet built from ' + in['FeatureSet_ref'] + ' with length ' +str(in['upstream_length'])
        SequenceSet['sequences'] = []
        prom= ""
        featureFound = False
